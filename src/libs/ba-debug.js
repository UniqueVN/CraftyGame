  ...
  while ( --idx >= 0 ) {
    (function( idx, level ){
      ...
      that[ level ] = function() {
		...
		// tht060212 - Show the function where the log called
		args.push(arguments.callee.caller.name);
		// tht060212 - Show the filename and the line number of the log
		// TODO: Fix this. It doesn't work right now
		//args.push((new Error).fileName);
		//args.push((new Error).lineNumber);
